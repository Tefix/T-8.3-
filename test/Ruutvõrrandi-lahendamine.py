...
nupp = tkinter.Button(frame, text="Решить", font=("Futura", 15), bg='red', fg='black', relief="ridge")
nupp.grid(row=0, column=6, padx=10)

graph_btn = tkinter.Button(frame, text="График", font=("Futura", 15), bg='red', fg='black', relief="ridge", command=plot_graph)
